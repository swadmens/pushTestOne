...
#import "TimeSystemViewController.h"//时间设置
#import "NearbyPeoplesController.h"//附近的人
#import "FootprintDetailsViewController.h"//足迹详情
#import "MessagesViewController.h"//消息
#import "MyFriendsViewController.h"//我的好友
#import "RegisteredViewController.h"//注册
#import "MyHomePageViewController.h"//我的主页
#import "SystemViewController.h"//设置
#import "PersonalInforViewController.h"//个人信息
#import "AccountSecurityController.h"//账户安全
#import "ChangePasswordController.h"//修改密码
#import "ShowTimeSystemController.h"//显示设置
#import "NearbyAreaSystemController.h"//附近足迹设置
#import "FriendsFootprintController.h"//好友足迹
#import "AllCommentsViewController.h"//全部评论
#import "ReleaseFootprintsController.h"//足迹发布
#import "PrivacySystemViewController.h"//足迹发布隐私设置
#import "FooterprintsToReportController.h"//足迹举报
#import "SafetyInspectionController.h"//安全校验
#import "ChangePhoneNumberController.h"//更换手机号
#import "MineCollectsController.h"//我的收藏
...
//            return;
            ...
            break;
        case PushTargetRegisteredView: //  快速注册
        {
        ...
        case PushTargetTimeSystem: //  时间设置
        {
            TimeSystemViewController *controller = [[TimeSystemViewController alloc] init];
            toController = controller;
        }
            break;
            case PushTargetNearbyPeoples: //  时间设置
        {
            NearbyPeoplesController *controller = [[NearbyPeoplesController alloc] init];
            toController = controller;
        }
            break;
            case PushTargetFootprintDetails: //  足迹详情
        {
            FootprintDetailsViewController *controller = [[FootprintDetailsViewController alloc] init];
            controller.footerId = pushId;
            toController = controller;
        }
            break;
            case PushTargetMessagesView: //  消息
        {
            MessagesViewController *controller = [[MessagesViewController alloc] init];
            toController = controller;
        }
            break;
            case PushTargetMyFriendsView: //  我的好友
        {
            MyFriendsViewController *controller = [[MyFriendsViewController alloc] init];
            toController = controller;
        }
            break;
            case PushTargetMyHomePageView: //  我的主页
        {
            MyHomePageViewController *controller = [[MyHomePageViewController alloc] init];
            toController = controller;
        }
            break;
            case PushTargetSystemView: //  设置
        {
            SystemViewController *controller = [[SystemViewController alloc] init];
            toController = controller;
        }
            break;
            case PushTargetPersonalInforView: //  个人信息
        {
            PersonalInforViewController *controller = [[PersonalInforViewController alloc] init];
            toController = controller;
        }
            break;
            case PushTargetAccountSecurity: //  账户安全
        {
            AccountSecurityController *controller = [[AccountSecurityController alloc] init];
            toController = controller;
        }
            break;
            case PushTargetChangePassword: //  修改密码
        {
            ChangePasswordController *controller = [[ChangePasswordController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetShowTimeSystem: //  显示设置
        {
            ShowTimeSystemController *controller = [[ShowTimeSystemController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetNearbyAreaSystem: //  附近足迹设置
        {
            NearbyAreaSystemController *controller = [[NearbyAreaSystemController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetFriendsFootprint: //  好友足迹
        {
            FriendsFootprintController *controller = [[FriendsFootprintController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetAllComments: //  全部评论
        {
            AllCommentsViewController *controller = [[AllCommentsViewController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetReleaseFootprints: //  足迹发布
        {
            ReleaseFootprintsController *controller = [[ReleaseFootprintsController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetPrivacySystem: //  足迹发布隐私设置
        {
            PrivacySystemViewController *controller = [[PrivacySystemViewController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetFooterprintsToReport: //  足迹举报
        {
            FooterprintsToReportController *controller = [[FooterprintsToReportController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetSafetyInspection: //  安全校验
        {
            SafetyInspectionController *controller = [[SafetyInspectionController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetChangePhoneNumber: //  更换手机号
        {
            ChangePhoneNumberController *controller = [[ChangePhoneNumberController alloc] init];
            toController = controller;
        }
            break;
        case PushTargetMineCollects: //  我的收藏
        {
            MineCollectsController *controller = [[MineCollectsController alloc] init];
            toController = controller;
        }
            break;
