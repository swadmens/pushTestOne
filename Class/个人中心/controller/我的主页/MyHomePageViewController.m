...
static NSString *_normalHeaderIdentifier = @"mine.header.normal";


@interface MyHomePageViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
{
...
//    [grButton setImage:UIImageWithFileName(@"mine_more_white_image") forState:UIControlStateNormal];
...
//    [grButton yCenterToView:button];
//    [grButton rightToView:self.view withSpace:6];
//    [grButton addWidth:40];
//    [grButton addHeight:30];
...
{
    MyHomePageHeaderView *headerView = [[MyHomePageHeaderView alloc]initWithReuseIdentifier:@"headerViewMy"];
    headerView.backgroundColor = kColorBackgroundColor;
    return headerView;
}
-(CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section
{
    return kScreenWidth/2 + 55;
}
