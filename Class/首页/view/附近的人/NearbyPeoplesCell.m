...
@property (nonatomic,strong) UILabel *fullTextLabel;//全文
...
@implementation NearbyPeoplesCell
...
- (void)dosetup {
    ...
    [_detailLabel topToView:_iconImageView withSpace:10];
