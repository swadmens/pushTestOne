...
MLLinkLabel *kMLLinkLabel()
{
    ...
    _linkLabel.font = [UIFont customFontWithSize:kFontSizeFifty];
    _linkLabel.numberOfLines = 0;
    _linkLabel.linkTextAttributes = @{NSForegroundColorAttributeName:kColorMainTextColor};
    _linkLabel.activeLinkTextAttributes = @{NSForegroundColorAttributeName:kColorMainTextColor,NSBackgroundColorAttributeName:kColorBackgroundColor};
...
//    }
    if ([object isKindOfClass:[NSString class]])
    {
        ...
        for (NSString *name in nameList) {
            [attributedText setAttributes:@{NSFontAttributeName:[UIFont customFontWithSize:kFontSizeFifty],NSLinkAttributeName:name}
