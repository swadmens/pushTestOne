...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        self.backgroundColor = UIColorFromRGB(0x000000, 0.9);
        ...
        // 页面控制
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height-40, kScreenWidth, 20)];
...
{
    _pageIndex = scrollView.contentOffset.x / self.frame.size.height;
