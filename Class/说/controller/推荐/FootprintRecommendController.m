//
//  FootprintRecommendController.m
//  HuiSheng
//
...
@interface FootprintRecommendController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation FootprintRecommendController
